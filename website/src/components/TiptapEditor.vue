  ...
  <div class="editorWrap" v-if="editor">
    <div class="toolbar">
      <div class="toolbarGroup">
        ...
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
            <path d="M17.12 18.12c-.95.64-2.23 1.12-3.62 1.12-3.31 0-5.5-1.57-5.5-4.5 0-1.12.25-2.02.81-2.74" /><path d="M6.88 5.88C7.8 5.08 9.14 4.5 10.5 4.5c3.31 0 5.5 1.57 5.5 4.5 0 .54-.09 1.04-.25 1.5" /><line x1="3" y1="12" x2="21" y2="12" />
          </svg>
        </button>
      </div>
      ...
      <div class="toolbarGroup">
        <button type="button"
          :class="['toolBtn', { active: editor.isActive('heading', { level: 1 }) }]"
          title="标题 1"
          @click="setHeading(1)"
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
            <path d="M3 12h10" /><path d="M3 6v12" /><path d="M13 6v12" /><path d="M18 10l3 4" /><path d="M21 10l-3 4" />
          </svg>
        </button>
        <button type="button"
          :class="['toolBtn', { active: editor.isActive('heading', { level: 2 }) }]"
          title="标题 2"
          @click="setHeading(2)"
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
            <path d="M3 12h10" /><path d="M3 6v12" /><path d="M13 6v12" /><path d="M17 12l3-4" /><path d="M20 12l-3 4" />
          </svg>
        </button>
        <button type="button"
          :class="['toolBtn', { active: editor.isActive('paragraph') && !editor.isActive('heading') }]"
          title="正文"
          @click="setHeading(null)"
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
            <line x1="3" y1="6" x2="21" y2="6" /><line x1="3" y1="10" x2="15" y2="10" /><line x1="3" y1="14" x2="18" y2="14" /><line x1="3" y1="18" x2="12" y2="18" />
          </svg>
        </button>
      </div>
      ...
      <div class="toolbarGroup">
        ...
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
            <line x1="9" y1="6" x2="21" y2="6" /><line x1="9" y1="12" x2="21" y2="12" /><line x1="9" y1="18" x2="21" y2="18" /><circle cx="4" cy="6" r="1" /><circle cx="4" cy="12" r="1" /><circle cx="4" cy="18" r="1" />
          </svg>
        </button>
        <button type="button"
        ...
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
            <polyline points="10 15 6 12 10 9" /><polyline points="14 9 18 12 14 15" />
          </svg>
        </button>
        <button type="button"
        ...
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
            <rect x="3" y="4" width="18" height="16" rx="2" /><line x1="8" y1="10" x2="16" y2="10" /><line x1="8" y1="14" x2="14" y2="14" />
          </svg>
        </button>
      </div>
...
.editorContent :deep(.hljs-keyword) { color: #c084fc; }
.editorContent :deep(.hljs-string) { color: #34d399; }
.editorContent :deep(.hljs-number) { color: #fbbf24; }
.editorContent :deep(.hljs-comment) { color: #64748b; font-style: italic; }
.editorContent :deep(.hljs-built_in) { color: #60a5fa; }
.editorContent :deep(.hljs-title) { color: #f472b6; }
.editorContent :deep(.hljs-params) { color: #e2e8f0; }
.editorContent :deep(.hljs-literal) { color: #c084fc; }
.editorContent :deep(.hljs-attr) { color: #fbbf24; }
.editorContent :deep(.hljs-selector-tag) { color: #c084fc; }
.editorContent :deep(.hljs-selector-class) { color: #f472b6; }
